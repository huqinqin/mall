    ...
    <div class="search">
        ...
        <div class="content" v-if="data.length > 0">
            ...
            <div class="search-result">
                <ul class="result">
                    <li v-for="item in data" :key="item.id" v-bind:class="{'limit':item.discount_type == 4,'reduce':item.discount_type == 2,'discount':item.discount_type == 1,'flashSale':(item.discount_type == 0 && ((4194304 & item.attribute) === 4194304)),'newSeller': item.isNew}">
