<template>
    <div class="search">
        <div class="navBar11" style="background-color: #F2AC31" v-if="search.discountType === 0">
            <p class="navBarSave">Save <span style="color: #D82929"> 20% </span>with<span style="color: #D82929"> $1000+ </span>purchase&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;Save <span style="color: #D82929"> 15% </span>with<span style="color: #D82929"> $500 - $999 </span>purchase&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;Save <span style="color: #D82929"> 10% </span>with<span style="color: #D82929"> $300 - $499 </span>purchase</p>
        </div>
        <div class="nav">
