    ...
    <div class="detail-top">
      <div class="detail-img-box">
        <div class="prc_info">
          ...
          <!--大图下面的小图-->
          <div class="small">
            <div class="small_img" v-for="prc in item.item_images" :key="prc.index" @mouseover="showImage(prc,$event)"
          ...
          <el-tabs v-model="activeName" @tab-click="handleClick" type="border-card">
            <el-tab-pane :label='$t("main.detail.info.mainDetInfoGoodsInfo")' name="first">
              <ul class="aboutDetail" :class="[showPropDetail ? 'propOpen' : 'propClose']">
                ...
                <li class="more" v-if="aboutDetail.length > 8" @click="showPropDetail = !showPropDetail">{{
                  $t("main.detail.info.mainDetInfoDetail") }} <i class="iconfont icon-shangyiye-copy-copy"></i></li>
              </ul>
