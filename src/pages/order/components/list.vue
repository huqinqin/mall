                                ...
                                <template slot-scope="subscope">
                                    <div class="item-info">
                                        <div class="order-item-detail">
                                            <img :src="subscope.row.wholesale_item_d_o.image_value + '!item_small'" class="item" />
                ...
                <template slot-scope="scope">
                    <el-dropdown @command="handleMenuItemClick">
                        ...
                        <el-dropdown-menu slot="dropdown" >
                            ...
                            <el-dropdown-item v-if="scope.row.status == 2 " command="sureAccept" :data="scope.row">{{$t("main.order.list.mainOrLiSureAccept")}}</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </template>
            </el-table-column>
