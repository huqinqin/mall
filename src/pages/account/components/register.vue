      ...
      <el-form label-position="top" :model="signupForm" :rules="rules">
        ...
        <el-form-item label="Upload distribution card" prop="pic">
          <el-upload
            ...
            <div class="el-upload__text">{{ $t("main.accountNew.register.mainAcReFileDragHere") }}<em>{{
              $t("main.accountNew.register.mainAcReClickUpload") }}</em></div>
          </el-upload>
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
          <el-button type="submit" class="confirm" :class="{canClick:signupForm.agree === true}" @click="submitFrom">
            <span>CREATE AN ACCOUNT</span></el-button>
        </el-form-item>
      </el-form>
    </main>
  </div>
